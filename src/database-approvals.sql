...
('PURCHASE_PAYMENT', 1, 0, 50000, 'ACCOUNTS_MANAGER', (SELECT id FROM organisations LIMIT 1)),
('PURCHASE_PAYMENT', 2, 50001, 200000, 'PROJECT_MANAGER', (SELECT id FROM organisations LIMIT 1)),
('PURCHASE_PAYMENT', 3, 200001, NULL, 'GENERAL_MANAGER', (SELECT id FROM organisations LIMIT 1)),
('SUBCONTRACTOR_PAYMENT', 1, 0, 50000, 'ACCOUNTS_MANAGER', (SELECT id FROM organisations LIMIT 1)),
('SUBCONTRACTOR_PAYMENT', 2, 50001, 200000, 'PROJECT_MANAGER', (SELECT id FROM organisations LIMIT 1)),
('SUBCONTRACTOR_PAYMENT', 3, 200001, NULL, 'GENERAL_MANAGER', (SELECT id FROM organisations LIMIT 1))
