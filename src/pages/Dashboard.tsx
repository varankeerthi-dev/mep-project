...
export default function Dashboard({ onNavigate }: { onNavigate?: (path: string) => void }) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: colors.gray[50] }}>
      ...
      {/* Main Content - Minimal Dashboard */}
      <div style={{ maxWidth: '1600px', margin: '0 auto', padding: '24px' }}>
        <div style={{
          ...
          <h1 style={{ fontSize: '32px', fontWeight: 700, color: colors.gray[900], margin: 0 }}>
            Dashboard
          </h1>
          <p style={{ fontSize: '16px', color: colors.gray[600], textAlign: 'center', margin: 0, maxWidth: '600px' }}>
            Dashboard layout is being refactored. This is a minimal placeholder while the new design is being implemented.
          </p>
          <div style={{
            display: 'flex',
            gap: '16px',
