...
export function SiteMaterials() { return <div><div className="page-header"><h1 className="page-title">Site Materials</h1></div><div className="card"><div className="empty-state"><h3>Site Materials</h3><p>Manage materials at project site</p></div></div></div>; }
...
export function IssueList() { return <div><div className="page-header"><h1 className="page-title">Issue</h1></div><div className="card"><div className="empty-state"><h3>Issues</h3></div></div></div>; }
