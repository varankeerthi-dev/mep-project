...
export function SubcontractorDashboard({ onNavigate }) {
...
export function CreateSubcontractor({ onSuccess, onCancel, editMode, subData }) {
...
export function SubcontractorView({ onNavigate }) {
...
export function SubcontractorEdit({ onNavigate }) {
  const [sub, setSub] = useState(null)
  useEffect(() => {
    const id = getCurrentQueryParams().get('id')
...
export function SubcontractorAttendance({ onNavigate }) {
  const [subcontractors, setSubcontractors] = useState([])
...
export function SubcontractorWorkOrders({ onNavigate }) {
  const [subcontractors, setSubcontractors] = useState([])
  const [subId, setSubId] = useState('')
...
export function SubcontractorDailyLogs({ onNavigate }) {
  const [subcontractors, setSubcontractors] = useState([])
  const [subId, setSubId] = useState('')
  const [workOrders, setWorkOrders] = useState([])
...
export function SubcontractorPayments({ onNavigate }) {
  const [subcontractors, setSubcontractors] = useState([])
  const [subId, setSubId] = useState('')
...
export function SubcontractorInvoices({ onNavigate }) {
  const [subcontractors, setSubcontractors] = useState([])
  const [subId, setSubId] = useState('')
  const [workOrders, setWorkOrders] = useState([])
  const [woId, setWoId] = useState('')
...
export function SubcontractorDocuments({ onNavigate }) {
  const [subcontractors, setSubcontractors] = useState([])
  const [subId, setSubId] = useState('')
