  ...
  return (
    <div className={cn('relative min-w-[200px] flex-1', className)}>
      ...
      <input
        ...
        className="h-8 w-full rounded-lg border border-zinc-200 bg-white pl-8 pr-8 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
      />
      {value && (
        <button
          type="button"
