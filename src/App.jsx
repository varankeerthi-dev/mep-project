      ...
      <div className="card">
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ background: '#f0fdf4', padding: '16px', borderRadius: '8px', marginBottom: '16px', border: '1px solid #bbf7d0' }}>
            <div style={{ fontWeight: '600', marginBottom: '12px', color: '#166534' }}>Billing Address</div>
            <div className="form-row">
          ...
          <div style={{ marginBottom: '16px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <button type="button" className="btn btn-secondary" onClick={copyBillingToShipping} style={{ whiteSpace: 'nowrap' }}>Copy Billing Address</button>
                <button type="button" className="btn btn-primary" onClick={() => setShowShippingForm(true)}>+ Add Shipping</button>
              </div>
            </div>
            ...
            {shippingAddresses.length > 0 && (
              <div style={{ display: 'grid', gap: '12px' }}>
                {shippingAddresses.map(addr => (
                  <div key={addr.id} style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '12px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                      <div>
                        <div style={{ fontWeight: '600', color: '#1e293b' }}>{addr.address_name || 'Address'} {addr.is_default && <span style={{ background: '#dbeafe', color: '#1d4ed8', padding: '2px 6px', borderRadius: '4px', fontSize: '11px' }}>Default</span>}</div>
                        <div style={{ color: '#64748b', fontSize: '13px', marginTop: '4px' }}>{addr.address_line1} {addr.address_line2}</div>
                        <div style={{ color: '#64748b', fontSize: '13px' }}>{addr.city}, {addr.state} - {addr.pincode}</div>
                      </div>
            ...
            {showShippingForm && (
              <div style={{ background: '#f0f9ff', padding: '16px', borderRadius: '8px', border: '1px solid #bae6fd', marginTop: '12px' }}>
                <div style={{ fontWeight: '600', marginBottom: '12px', color: '#0369a1' }}>Add New Shipping Address</div>
                <div className="form-row">
