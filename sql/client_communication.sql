...
-- Create RLS policies
CREATE POLICY "Enable all access for authenticated users" ON client_communication
...
-- Add to storage
INSERT INTO storage.buckets (id, name, public) VALUES ('client-communication', 'client-communication', false)
