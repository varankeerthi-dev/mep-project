...
ALTER TABLE delivery_challan_items ADD COLUMN IF NOT EXISTS description TEXT;
...
COMMENT ON COLUMN delivery_challan_items.description IS 'Manual per-item description, document-specific';
