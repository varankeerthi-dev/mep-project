-- Migration 042: Fix org membership checks to include org_members table
-- The org creator (and RBAC-managed users) exist in org_members, not user_organisations.
-- All SECURITY DEFINER functions and RLS policies must check BOTH tables.

-- ================================================================
-- Helper function: checks membership in EITHER user_organisations OR org_members
-- ================================================================
...
-- ================================================================
-- FIX SECURITY DEFINER FUNCTIONS — use is_org_member helper
-- ================================================================
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE p.id = p_project_id
      AND is_org_member(auth.uid(), p.organisation_id)
  ) THEN
...
-- ================================================================
-- FIX ALL RLS POLICIES that referenced user_organisations directly
-- Replace with is_org_member() for consistency
-- ================================================================
