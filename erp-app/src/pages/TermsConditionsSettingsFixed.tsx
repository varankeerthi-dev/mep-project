...
// Custom ScrollArea component since it's missing
...
// Custom Collapsible component since it's missing
...
const CollapsibleTrigger: React.FC<{ children: React.ReactNode; open?: boolean; onOpenChange?: (open: boolean) => void; className?: string }> = ({ 
  children, 
  open, 
  onOpenChange, 
  className = '' 
...
const CollapsibleContent: React.FC<{ children: React.ReactNode; open?: boolean }> = ({ children, open }) => (
      ...
      <div className="container mx-auto p-6 space-y-6">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="h-64 bg-zinc-200 rounded-lg lg:col-span-3"></div>
          </div>
        </div>
      </div>
    );
                  ...
                  {selectedTemplate.sections.map((section, sectionIndex) => (
                    <Card key={section.id} className="border">
                      ...
                      >
                        ...
                        <CollapsibleContent open={expandedSections.has(section.id)}>
