    ...
    <div className="p-6 bg-white" style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="default" size="sm" onClick={() => setEditing(!editing)}
          ...
          {editing && (
            <>
              ...
              <Button variant="default" size="sm" onClick={resetToDefault} >
                Reset
              </Button>
              <Button variant="default" size="sm" onClick={saveTerms} disabled={!hasChanges} >
                Save
              </Button>
            </>
          )}
          ...
          {(provided) => (
            <div {...provided.droppableProps} ref={provided.innerRef}>
              {sections.map((section, sectionIndex) => (
                <Draggable key={section.id} draggableId={section.id} index={sectionIndex} isDragDisabled={!editing}>
                  {(provided, snapshot) => (
                    <div
                      ref={provided.innerRef}
                      {...provided.draggableProps}
                      className={`mb-6 border rounded-lg ${snapshot.isDragging ? 'shadow-lg' : ''} ${
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between p-4 bg-zinc-50 border-b">
                        ...
                        {editing && (
                          <div className="flex items-center gap-2">
                            <Button variant="default" size="sm" onClick={() => addItem(section.id)}
                            ...
                            <Button variant="default" size="sm" onClick={() => deleteSection(section.id)}
                      ...
                      <div className="p-4">
                        {section.items.map((item, itemIndex) => (
                          <div key={item.id} className="flex items-start gap-2 mb-2 last:mb-0">
                            ...
                            {editing && (
                              <Button variant="default" size="sm" onClick={() => deleteItem(section.id, item.id)}
                                className="p-1 text-red-600 hover:bg-red-50 rounded"
                                title="Delete item"
                              >
