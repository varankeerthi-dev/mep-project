  ...
  return (
    <div className="flex flex-col h-full bg-white relative">
            ...
            <div className="flex items-center gap-3">
              {renderBulkActions
                ...
                : (
                  <>
                    {onBulkPrint && (
                      <Button variant="default" size="sm" onClick={() => onBulkPrint(selectedIds)}
      ...
      >
        <div className="flex items-center gap-2">
          {subTabs.map((tab) => (
            <Button variant="default" size="sm" key={tab.label} onClick={() => setSubTab(tab.label)}
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {showStatusDropdown && (
                <div className="absolute left-0 top-full mt-1 z-50 min-w-[160px] bg-white border border-zinc-200 rounded-lg shadow-lg py-1">
                  <Button variant="default" size="sm" onClick={() => { setStatusFilter('All'); setShowStatusDropdown(false); }}
                  ...
                  {statuses.map((status) => (
                    <Button variant="default" size="sm" key={status} onClick={() => { setStatusFilter(status); setShowStatusDropdown(false); }}
                      className={`block w-full text-left px-3 py-2 text-sm transition-colors ${
        ...
        <div className="flex items-center gap-[10px]">
          {onCreateClick && (
            <Button variant="default" size="icon-xs" onClick={onCreateClick} >
      ...
      <div className="flex items-center justify-between px-6 py-4 border-t border-zinc-200 bg-zinc-50/50">
        ...
        <div className="flex items-center gap-2">
          <Button variant="default" size="sm" onClick={() => setCurrentPage(currentPage - 1)}
