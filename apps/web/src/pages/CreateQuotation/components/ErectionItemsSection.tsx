...
interface ErectionItemsSectionProps {
  items: any[];
  materials: any[];
  variants: any[];
  variantPricing: any;
...
export function ErectionItemsSection({
  items,
  materials,
  variants,
  variantPricing,
            ...
            <>
              ...
              return (
                <tr 
                  ...
                  className={`${draggingItemId === item.id ? 'row-dragging' : ''} ${item.is_override ? 'override-indicator' : ''} erection-row`}
                ...
                >
                  ...
                  <td 
                    ...
                    onDragEnd={handleDragEnd}
                  >
                    {materialCount + itemCountBefore + 1}
                  </td>
                  {(templateSettings?.column_settings?.optional?.hsn_code !== false) && (
                  ...
                  <td className="delete-cell col-shrink" style={{ paddingLeft: '8px' }}>
                    <div style={{ display: 'flex', gap: '4px', justifyContent: 'flex-end', position: 'relative' }}>
                      <button
                        ...
                        onClick={() => openMoveToDialog(item.id, itemCountBefore + 1, 'erection')}
                        style={{
                          padding: '2px 6px',
                          fontSize: '12px',
                          background: '#f1f5f9',
