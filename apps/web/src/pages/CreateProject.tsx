  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden divide-y divide-slate-100">
      ...
      <div className="p-5 space-y-4 max-h-[calc(100vh-220px)] overflow-y-auto">
        {/* Identity & Commercials Card */}
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-xs font-bold text-slate-800 uppercase tracking-wider">
              <Building2 className="w-4 h-4 text-blue-600" />
              <span>Identity & Commercials</span>
            </div>
            <button
              type="button"
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div>
              ...
              <span className="font-semibold text-slate-900">
                {selectedClient ? selectedClient.client_name : (formData.client_id ? 'Selected' : '—')}
              </span>
            </div>
            <div>
              <span className="text-slate-500 font-medium block">Project Type</span>
            ...
            {formData.site_location && (
              <div className="col-span-2">
                ...
                <span className="font-medium text-slate-800">{formData.site_location}</span>
              </div>
            )}
          </div>
        </div>

        {/* Commercials & Schedule Card */}
        {currentStep >= 1 && (
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-xs font-bold text-slate-800 uppercase tracking-wider">
