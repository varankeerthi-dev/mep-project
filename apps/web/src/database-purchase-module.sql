...
CREATE TABLE IF NOT EXISTS purchase_vendors (
  ...
  msme_register_type VARCHAR(50),
  msme_number VARCHAR(100),
  gst_treatment VARCHAR(50),
  pan_card_url TEXT,
  cheque_leaf_url TEXT,
...
CREATE TABLE IF NOT EXISTS purchase_payments (
  ...
  has_vendor_proforma BOOLEAN DEFAULT false,
  vendor_proforma_invoice TEXT,
  vendor_proforma_date DATE,
  vendor_proforma_amount DECIMAL(15,2),
