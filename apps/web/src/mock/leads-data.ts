...
import type { CadenceRule, Lead, LeadIndustry, LeadStatus, NextAction, WinLossReason } from '../types/leads';
...
export const MOCK_LEADS: Lead[] = [
  {
    ...
    pin: '400001',
    industry_id: null,
    referred_by: 'Vikram Patel',
    remarks: 'Met at Big5 Construct India. Very interested in HVAC retrofit solutions.',
    lead_status_id: null,
...
export const MOCK_LEAD_STATUSES: LeadStatus[] = [
  { id: 'ls-1', organisation_id: 'mock-org', name: 'Attempted to Contact', color: '#F59E0B', sort_order: 1, is_default: true, category: 'open', created_at: NOW },
  { id: 'ls-2', organisation_id: 'mock-org', name: 'Contact in Future', color: '#3B82F6', sort_order: 2, is_default: false, category: 'open', created_at: NOW },
  { id: 'ls-3', organisation_id: 'mock-org', name: 'Contacted', color: '#10B981', sort_order: 3, is_default: false, category: 'open', created_at: NOW },
  { id: 'ls-4', organisation_id: 'mock-org', name: 'Not Contacted', color: '#6B7280', sort_order: 4, is_default: false, category: 'open', created_at: NOW },
  { id: 'ls-5', organisation_id: 'mock-org', name: 'Pre-Qualified', color: '#8B5CF6', sort_order: 5, is_default: false, category: 'open', created_at: NOW },
  { id: 'ls-6', organisation_id: 'mock-org', name: 'Not Qualified', color: '#EF4444', sort_order: 6, is_default: false, category: 'lost', created_at: NOW },
  { id: 'ls-7', organisation_id: 'mock-org', name: 'Junk Lead', color: '#DC2626', sort_order: 7, is_default: false, category: 'junk', created_at: NOW },
  { id: 'ls-8', organisation_id: 'mock-org', name: 'Lost Lead', color: '#991B1B', sort_order: 8, is_default: false, category: 'lost', created_at: NOW },
];

export const MOCK_LEAD_INDUSTRIES: LeadIndustry[] = [
  { id: 'li-1', organisation_id: 'mock-org', name: 'Government/Military', sort_order: 1, created_at: NOW },
  { id: 'li-2', organisation_id: 'mock-org', name: 'Large Enterprise', sort_order: 2, created_at: NOW },
  { id: 'li-3', organisation_id: 'mock-org', name: 'Service Provider', sort_order: 3, created_at: NOW },
  { id: 'li-4', organisation_id: 'mock-org', name: 'Small/Medium Enterprise', sort_order: 4, created_at: NOW },
];
