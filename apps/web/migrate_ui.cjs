                    ...
                    return (
                      ...
                      >
                        ...
                        <td style={{ padding: '12px 8px', textAlign: 'center' }}>
                          <button type="button" onClick={() => removeLineItem(index)} style={{ border: 'none', background: 'transparent', cursor: 'pointer', color: '#ef4444' }}><Trash2 size={16}/></button>
                        </td>
                      </tr>
                    );
                  }
                      ...
                      >
                        ...
                        <td colSpan={100} style={{ padding: '12px 8px' }}>
                          <div style={{ display: 'flex', justifyContent: 'space-between', fontWeight: 'bold', color: '#854d0e' }}>
                            ...
                            />
                            {/* In a real implementation we would dynamically compute the subtotal up to this point */}
                            <span>SUBTOTAL ROW (Calculations handled dynamically)</span>
                          </div>
                        </td>
                        <td style={{ padding: '12px 8px', textAlign: 'center' }}>
                          <button type="button" onClick={() => removeLineItem(index)} style={{ border: 'none', background: 'transparent', cursor: 'pointer', color: '#ef4444' }}><Trash2 size={16}/></button>
                    ...
                    >
                      ...
                      <td style={{ padding: '8px' }}>
                        ...
                        <div style={{ marginTop: '4px', textAlign: 'right' }}>
                          <button type="button" onClick={() => toggleEntryMode(index)} style={{ background: 'none', border: 'none', fontSize: '10px', color: '#3b82f6', cursor: 'pointer' }}>Toggle Entry Mode</button>
                        </div>
                      </td>
                        ...
                        <td style={{ padding: '8px' }}>
                          <select 
                            ...
                            onChange={e => {
                               ...
                               // Try to fetch auto-learning price here in full implementation
                               setLineItems(updated);
                            }}
                        ...
                        <td style={{ padding: '8px' }}>
                          <input 
                            ...
                            onChange={e => {
                              ...
                              updated[index].rate_per_unit = val; // keep sync
                              setLineItems(updated);
                            }}
...
if (startIndex !== -1 && endIndex !== -1) {
  content = content.slice(0, startIndex) + newUI.trim() + '\\n        ' + content.slice(endIndex + endToken.length);
